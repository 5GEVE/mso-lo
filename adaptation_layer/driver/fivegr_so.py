...
class FIVEGR_SO(Driver):
    ...
    def get_op_list(self, args: Dict = None) -> Tuple[BodyList, Headers]:
        raise NotImplementedError(
            'get_op_list is not implemented: 5gr-so does not support querying multiple operations')
...
class IFA013NsInfo:
    def __init__(self, nsInstanceId="", nsName="", description="", nsdId="", flavourId="", vnfInfoId=None,
                 pnfInfo=None,
                 virtualLinkInfo=None, vnffgInfo=None, sapInfo=None, nestedNsInfoId=None, nsState="",
                 nsScaleStatus=None,
        ...
        self.additionalAffinityOrAntiAffinityRule: List[
            IFA013AffinityOrAntiAffinityRule] = []  # AffinityOrAntiAffinityRule
...
class IFA013InstantiateNsRequest:
    def __init__(self, nsInstanceId="", flavourId="", sapData=None, pnfInfo=None, vnfInstanceData=None,
                 nestedNsInstanceId="", locationConstraints=None, additionalParamForNs=None,
                 additionalParamForVnf=None,
        ...
        [self.locationConstraints.append(IFA013VnfLocationConstraint(**element)) for element in
         locationConstraints or []]
        self.additionalParamForNs: Dict = {}
        if additionalParamForNs is not None: self.additionalParamForNs = additionalParamForNs
...
class SOL005VnfInstance:
    def __init__(self, id="", vnfInstanceName="", vnfInstanceDescription="", vnfdId="", vnfProvider="",
                 vnfProductName="",
...
class SOL005NfpRule:
    def __init__(self, etherDestinationAddress="", etherSourceAddress="", etherType="", vlanTag="", protocol="",
                 dscp="",
...
class SOL005NfpInfo:
    def __init__(self, id="", nfpdId="", nfpName="", description="", cpGroup=None, totalCp="", nfpRule=None,
                 nfpState=""):
        self.id: str = id
...
class SOL005InstantiateNsRequest:
    def __init__(self, nsFlavourId="", sapData=None, addpnfData=None, vnfInstanceData=None, nestedNsInstanceData=None,
        ...
        [self.nestedNsInstanceData.append(SOL005NestedNsInstanceData(**element)) for element in
         nestedNsInstanceData or []]
        self.locationConstraints: List[SOL005VnfLocationConstraint] = []
        [self.locationConstraints.append(SOL005VnfLocationConstraint(**element)) for element in
         locationConstraints or []]
...
class SOL005NsLcmOpOcc:
    def __init__(self, id="", operationState="", stateEnteredTime="", nsInstanceId="", lcmOperationType="",
                 startTime="", isAutomaticInvocation=False, operationParams=None, isCancelPending=False, cancelMode="",
                 error=None, resourceChanges=""):
        self.id = id
