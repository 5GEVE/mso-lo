...
from .request_mock import mock_ns, mock_ns_scale_v2, mock_ns_terminate, \
    mock_ns_instantiatev2, mock_ns_instantiate
from .response_schemas import ns_lcm_op_occ_schema, ns_schema
...
class fivegrSOTestCase(unittest.TestCase):
    ...
    def test_instantiate_ns_202(self):
        res = self.client().post('/nfvo/4/ns_instances/49ccb6a2-5bcd-4f35-a2cf-7728c54e48b7/instantiate?__code=200',
                                 json=mock_ns_instantiatev2)
    ...
    def test_instantiate_ns_400(self):
        res = self.client().post('/nfvo/4/ns_instances/49ccb6a2-5bcd-4f35-a2cf-7728c54e48b7/instantiate?__code=400',
                                 json=mock_ns_instantiate)
        self.assertEqual(400, res.status_code)

    def test_instantiate_ns_404(self):
        res = self.client().post('/nfvo/4/ns_instances/49ccb6a2-5bcd-4f35-a2cf-7728c54e48b9/instantiate?__code=404',
                                 json=mock_ns_instantiatev2)
        self.assertEqual(404, res.status_code)
